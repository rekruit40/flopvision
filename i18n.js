...
const T = {
  en: {
    ...
    "feat.gto.p": "Rake-adjusted solver solutions for single-raised and 3-bet pots, with per-combo action frequencies.",
    "feat.trainer.h": "Trainer",
    "feat.trainer.p": "Quiz yourself on solver-correct flop decisions, hand after hand.",
    "feat.leak.h": "Leak Map",
    "feat.leak.p": "Turns your trainer mistakes into weak themes — by spot, street and texture — that you can re-deal and drill.",
    ...
    "howto.s4.p": "Pick a spot — single-raised or 3-bet, rake-adjusted — and read per-hand action frequencies straight from the solver.",
    "howto.s5.h": "5 · Train",
    "howto.s5.p": "Quiz yourself hand after hand and get instant, solver-correct feedback.",
    "howto.s6.h": "6 · Review your leaks",
    "howto.s6.p": "Open the Leak Map to see which spots, streets and textures you miss most — then re-deal and fix them.",
    ...
    "priv.who.p": "This app is developed and published by FlopVision. FlopVision is the developer and the data controller responsible for this app and this Privacy Policy. You can reach us at rekruit40@gmail.com.",
    "priv.sum.h": "Summary",
  ...
  ru: {
    ...
    "feat.gto.p": "Решения солвера с учётом рейка для single-raised и 3-бет потов, с частотами действий по каждому комбо.",
    "feat.trainer.h": "Тренажёр",
    "feat.trainer.p": "Проверяй себя на GTO-верных решениях на флопе, рука за рукой.",
    "feat.leak.h": "Карта ликов",
    "feat.leak.p": "Превращает ошибки тренажёра в слабые темы — по споту, улице и текстуре — которые можно пересдать и отработать.",
    ...
    "howto.s4.p": "Выбери спот — single-raised или 3-бет, с учётом рейка — и читай частоты действий по каждой руке прямо из солвера.",
    "howto.s5.h": "5 · Тренируйся",
    "howto.s5.p": "Проверяй себя рука за рукой и получай мгновенный GTO-верный фидбек.",
    "howto.s6.h": "6 · Разбирай ошибки",
    "howto.s6.p": "Открой Карту ликов, чтобы увидеть, какие споты, улицы и текстуры даются хуже всего — и пересдай их, чтобы закрепить.",
    ...
    "shots.cap3": "3-бет стратегия",
    "shots.cap4": "Карта ликов",
    "shots.cap5": "Тренажёр",
    "shots.cap6": "Споты",
    "shots.ph": "Скриншот\nскоро",
    ...
    "priv.who.h": "Кто мы",
    "priv.who.p": "Это приложение разрабатывается и издаётся FlopVision. FlopVision является разработчиком и контроллером данных, ответственным за это приложение и за настоящую Политику конфиденциальности. Связаться с нами: rekruit40@gmail.com.",
    "priv.sum.h": "Кратко",
  ...
  zh: {
    ...
    "feat.gto.h": "GTO 查看器",
    "feat.gto.p": "考虑抽水的求解器方案，涵盖单加注与 3-bet 底池，含每个组合的行动频率。",
    "feat.trainer.h": "训练器",
    "feat.trainer.p": "一手接一手地测试你在翻牌的 GTO 正确决策。",
    "feat.leak.h": "漏洞图",
    "feat.leak.p": "把训练器中的失误归类为薄弱主题——按场景、街道与牌面结构——可重新发牌并反复练习。",
    ...
    "howto.s4.h": "4 · 学习 GTO",
    "howto.s4.p": "选择一个场景——单加注或 3-bet、考虑抽水——直接读取求解器给出的每手行动频率。",
    "howto.s5.h": "5 · 训练",
    "howto.s5.p": "一手接一手地测试自己，获得即时的、符合求解器的反馈。",
    "howto.s6.h": "6 · 复盘漏洞",
    "howto.s6.p": "打开漏洞图，看看哪些场景、街道和牌面结构最常出错——然后重新发牌并加以修正。",
    ...
    "priv.who.h": "我们是谁",
    "priv.who.p": "本应用由 FlopVision 开发和发布。FlopVision 是负责本应用及本隐私政策的开发者和数据控制者。你可以通过 rekruit40@gmail.com 与我们联系。",
    "priv.sum.h": "摘要",
